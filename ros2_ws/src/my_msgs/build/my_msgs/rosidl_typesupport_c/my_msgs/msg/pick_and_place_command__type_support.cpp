...
static const _PickAndPlaceCommand_type_support_symbol_names_t _PickAndPlaceCommand_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, my_msgs, msg, PickAndPlaceCommand)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, my_msgs, msg, PickAndPlaceCommand)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, my_msgs, msg, PickAndPlaceCommand)() {
  return &::my_msgs::msg::rosidl_typesupport_c::PickAndPlaceCommand_message_type_support_handle;
}
